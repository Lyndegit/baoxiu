<template>
	<view class="content">
		...
		<view class="main" v-for="dataList in categoryList" :key="dataList.fixid">  
			<NAUIcard :listData="categoryList"  :id="dataList.fixid" :imgurl="dataList.imgurl" :content="dataList.content" :avatarurl="dataList.touxiang"  :type="dataList.type1" :creat_time="dataList.timenow" :username="dataList.username"></NAUIcard>
		</view>
		</mescroll-uni>
...
<script>
	...
	export default {    
		...
		// 			uni.request({
		// 				url: 'http://192.168.30.41:8081/findAll?pageNum='+pageNum+'&pageSize='+pageSize,
		// 				success: (data) => {
		// 					// 接口返回的当前页数据列表 (数组)
